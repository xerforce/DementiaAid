...
public class GeneratedChartDemo extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// getString(R.string....)
		mMenuText = new String[] { "Line chart", "Scatter chart", "Time chart",
				"Bar chart" };
		mMenuSummary = new String[] {
				"Line chart with randomly generated values",
				"Scatter chart with randomly generated values",
				"Time chart with randomly generated values",
	...
	private XYMultipleSeriesDataset getDateDemoDataset() {
		...
		for (int i = 0; i < SERIES_NR; i++) {
			...
			for (int k = 0; k < nr; k++) {
				series.add(new Date(value + k * TimeChart.DAY / 4),
						20 + r.nextInt() % 100);
			}
			dataset.addSeries(series);
		}
