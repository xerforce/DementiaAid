...
public class FragmentRestroomTabMonthly extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		return inflater.inflate(R.layout.fragment_tab_monthly, container, false);
	}
	...
	public void onResume() {
		...
		if (mChartView == null) {
			linearLayout_chart = (LinearLayout) getView().findViewById(R.id.linearlayout_monthly_chart);
