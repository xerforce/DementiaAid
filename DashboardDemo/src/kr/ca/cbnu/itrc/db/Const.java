/**
 *  
 *  Android app sends url request to PHP which is exposed as webservice to communicate with the remote Mysql server   
 */
package kr.ca.cbnu.itrc.db;
...
public class Const {
	...
	private static String PHPWebserviceIp="http://210.115.182.145";  //refer to the real php server ip
	
	private static String PHPFolderPath="/php_projects/test/"; //modify accordingly also
