 ...
 */
public class ChartHelper implements IDemoChart {
	 ...
	 */
	protected static CategorySeries buildCategoryDataset(String title, double[] values) {
	 ...
	 * @return the category series
	 */
	protected static MultipleCategorySeries buildMultipleCategoryDataset(String title,
